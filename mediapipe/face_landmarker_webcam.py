...
# https://github.com/google-ai-edge/mediapipe/blob/9e4f898b22cf445c0ba7edc81ab4eb669fd71e89/mediapipe/python/solutions/face_mesh_connections.py#L16
...
def draw_landmarks_on_image(rgb_image, detection_result):
    ...
    for face_landmarks in detection_result.face_landmarks:
        ...
        draw_landmarks(
            ...
            landmark_drawing_spec=None,
            connection_drawing_spec=DrawingSpec(color=(0, 0, 255), thickness=2, circle_radius=0),
        )
        draw_landmarks(
            image=annotated_image,
            landmark_list=face_landmarks,
            ...
            landmark_drawing_spec=None,
            connection_drawing_spec=DrawingSpec(color=(0, 255, 255), thickness=1, circle_radius=0),
        )
        draw_landmarks(
            image=annotated_image,
            landmark_list=face_landmarks,
            ...
            landmark_drawing_spec=None,
            connection_drawing_spec=DrawingSpec(color=(0, 255, 0), thickness=2, circle_radius=0),
        )
        draw_landmarks(
            image=annotated_image,
            landmark_list=face_landmarks,
            ...
            landmark_drawing_spec=None,
            connection_drawing_spec=DrawingSpec(color=(255, 0, 0), thickness=1, circle_radius=0),
        )
        draw_landmarks(
            image=annotated_image,
            landmark_list=face_landmarks,
        ...
        draw_landmarks(
            ...
            landmark_drawing_spec=None,
            connection_drawing_spec=DrawingSpec(color=(255, 255, 0), thickness=2, circle_radius=0),
        )
        draw_landmarks(
            image=annotated_image,
            landmark_list=face_landmarks,
