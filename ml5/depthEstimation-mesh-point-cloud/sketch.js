 ...
 * Documentation: https://docs.ml5js.org/#/reference/depthestimation
 * Sources: https://github.com/ml5js/ml5-next-gen/tree/main/examples/depthEstimation-mesh-p5-2.0
 *          https://github.com/ml5js/ml5-next-gen/tree/main/examples/depthEstimation-point-cloud-p5-2.0
 */
...
// A function to draw the predicted depthmap as a mesh
// Source: https://github.com/ml5js/ml5-next-gen/blob/main/examples/depthEstimation-mesh-p5-2.0/sketch.js
function drawMesh() {
...
// A function to use the predicted depth map to draw a point cloud 
// Source: https://github.com/ml5js/ml5-next-gen/blob/main/examples/depthEstimation-point-cloud-p5-2.0/sketch.js
  ...
  for (let y = 0; y < sourceFrame.height; y++) {
    for (let x = 0; x < sourceFrame.width; x++) {
      ...
      if (depthAtPixel > 0) {
        ...
        translate( -width / 2 + videoWidth / 2, -height / 2 + videoHeight / 2, 0);
        ...
        fill(sourceFrame.pixels[index + 0], sourceFrame.pixels[index + 1], sourceFrame.pixels[index + 2], 255);
