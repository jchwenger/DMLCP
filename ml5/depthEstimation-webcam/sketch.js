 ...
 * Sources: https://github.com/ml5js/ml5-next-gen/tree/main/examples/depthEstimation-mask-background-p5-2.0
 *          https://github.com/ml5js/ml5-next-gen/tree/main/examples/depthEstimation-webcam-p5-2.0
 */
...
// false: show webcam feed; true: show image background
let backdrop;
...
function keyPressed() {
  if (key === " ") {
    ...
    console.log(`Showing backdrop? ${showBackdrop}`);
  }
}

function mousePressed() {
  console.log("Predicted depth map:", depthMap);
}
