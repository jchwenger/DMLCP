 ...
 * Source: https://github.com/ml5js/ml5-next-gen/tree/main/examples/neuralNetwork-color-classifier-p5-2.0
 */
...
function mousePressed() {
  // An object with ordered predictions (highest first: {red-ish: 0.8, label: 'red-ish', confidence: 0.8};
