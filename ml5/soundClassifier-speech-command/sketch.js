 ...
 * Source: https://github.com/ml5js/ml5-next-gen/tree/main/examples/soundClassifier-speech-command-p5-2.0
...
// TODO: check why they didn't include _unknown_ and _background_noise_
let words = [
  "zero",
  "one",
  "two",
...
function displayWords() {
  // IDEA: change the code so that instead of the predicted word appearing above,
  //       the prediction changes the highlighting in the list...
  textAlign(CENTER, CENTER);
  textSize(32);
  fill(96);
